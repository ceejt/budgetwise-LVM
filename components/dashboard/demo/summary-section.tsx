          ...
          <div className="relative w-48 h-48 mx-auto">
            <svg className="w-full h-full" viewBox="0 0 100 100">
              ...
              {Object.entries(categoryTotals).map(
                ([category, amount], index, arr) => {
                  const percentage = (amount / totalExpenses) * 100;
                  const offset = arr
                    .slice(0, index)
                    .reduce(
                      (sum, [, amt]) => sum + (amt / totalExpenses) * 251.2,
                      0
                    );
                  return (
                    <circle
      ...
      {goals.find((g) => g.name === "Scholarship") && (
        <div className="bg-white rounded-3xl p-6 shadow-sm">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 rounded-2xl p-4 text-white">
            ...
            <div className="text-sm opacity-80">CYRIL JOSEF TINAE</div>
          </div>
        </div>
      )}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xl font-bold">
                  ₱ {primaryWallet.balance.toFixed(0)}
                </div>
              </div>
              <div>
      ...
      <Dialog open={walletDialogOpen} onOpenChange={setWalletDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your GCash or Maya account
            </DialogDescription>
          </DialogHeader>
